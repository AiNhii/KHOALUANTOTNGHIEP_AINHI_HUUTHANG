# -*- coding: utf-8 -*-
"""Peephole_LSTM_BTC.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1k7X-YTD3kfgT6_tHpPnMXqQQdj0wpNHm
"""
...
df = pd.read_csv("/content/drive/MyDrive/dataset/btc.csv", parse_dates=True, index_col="formatted_date")
df.head()
...
final_model.fit(x_train, y_train, epochs=500, batch_size=1, verbose=2, shuffle=False)
