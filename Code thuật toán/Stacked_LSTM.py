...
def create_model(drop,input_shape, lr, momentum):
  model = Sequential()
...
final_model = create_model(drop=best_params['drop'], input_shape=best_params['input_shape'],lr = best_params['lr'], momentum = best_params['momentum'])
