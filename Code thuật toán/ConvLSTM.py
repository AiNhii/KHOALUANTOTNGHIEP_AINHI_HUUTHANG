...
Original file is located at
    https://colab.research.google.com/drive/1MAi5jBNKjYpmGYn6IYrLAiDr8qaqm8SC
"""
...
def create_model(drop, n_seq, n_steps, n_features):
  model = Sequential()
...
final_model = create_model(drop=best_params['drop'], n_seq = best_params ['n_seq'], n_features = best_params['n_features'], n_steps = best_params['n_steps'])
