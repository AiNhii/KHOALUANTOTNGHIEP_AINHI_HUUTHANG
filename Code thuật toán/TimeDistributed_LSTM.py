...
def create_model(n_neurons, input_shape=(1,)):
    model = Sequential()
    model.add(TimeDistributed(Dense(64), input_shape=input_shape))
...
param_grid = {
    ...
    'input_shape': [(1,9), (3,9), (5,9), (7,9), (10,9), (20,9)]
}
...
final_model = create_model(n_neurons=best_params['n_neurons'], input_shape=best_params['input_shape'])
